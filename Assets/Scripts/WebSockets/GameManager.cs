...
using WebSockets.InMessageData;
using OutJoinData = WebSockets.OutMessageData.JoinData;
using OutSpawnData = WebSockets.OutMessageData.SpawnData;
using OutHeartbeatData = WebSockets.OutMessageData.HeartbeatData;
using Entities;
using Interfaces;
...
namespace WebSockets
{
    ...
    public class GameManager : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            ws = GetComponent<WebSocketManager>();
        }
